...
function BallCenter() {
    ...
    a = c.appendChild(e);
    for (var f = 0, g = 0, h = b.rows, i = b.circleRadio, j = b.circleMargin, k = b.rows * b.lines, l = 2 * i + j, m = (b.circleStrokeColor, 
    k - 1), n = 0; m >= 0; m--, n++) {
...
function MemoryCore() {
    ...
    var b = this, c = MemoryGame.MODEL.gameConfiguration, d = (document.getElementById(c.ballAreaId), 
    MemoryGame.MODEL.view.ballCenter.ball_arr), e = d.length, f = MemoryGame.MODEL.view.ballCenter.interface, g = new UserRewardRoom(), h = [ 3, 5, 7, 9, 11, 13, 15 ], i = 0, j = 500, k = 300, l = 1e3, m = [], n = [];
    pingItem = {
        timer: 0,
        round: 0,
        splashItem: function(a) {
            var b = f.accessItem.border(a);
        ...
        pausePing: function() {
            2 === i ? (pingItem.startPing(), b.disableCircles(), g.reward.clear()) : (i = 2, 
            b.enableCircles(), clearInterval(pingItem.timer));
        },
        stopPing: function() {
            i = 0;
        }
        ...
        userSelection: function(a) {
            n.push(a), n.length === m.length && (b.disableCircles(), compareSelection.checkIfCorrect());
        },
        checkIfCorrect: function() {
            console.log("checking"), n.compare(m) ? (h++, g.reward.userWin(), setTimeout(function() {
                pingItem.pausePing();
            }, l)) : (console.log("Error"), compareSelection.clear(), g.reward.userFail());
        }
        ...
        f.controlItems.enableAll();
    }, this.disableCircles = function() {
        f.controlItems.disableAll();
    };
}

function UserRewardRoom() {
    var a = MemoryGame.MODEL.gameConfiguration, b = (document.getElementById(a.rewardroomId), 
    document.getElementById("msg")), c = "";
    return reward = {
        nextLevel: function() {},
        userWin: function() {
...
!function() {
    function a(a) {
        UTILITY.mergeOb(b, a), MemoryGame.MODEL.gameConfiguration = b;
        new View(), new MemoryCore();
    }
    var b = {
        gameNodeId: "game",
        ballAreaId: "ballBox",
