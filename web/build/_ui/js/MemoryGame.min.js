...
function Ball(a) {
    ...
    var b = this, c = {
        click: function() {
            MemoryGame.MODEL.core.compareSelection.userSelection(a);
        },
...
function MemoryCore() {
    ...
    var d = MemoryGame.MODEL.gameConfiguration;
    document.getElementById(d.ballAreaId);
    var e = MemoryGame.MODEL.view.ballCenter.ball_arr, f = e.length, g = MemoryGame.MODEL.view.ballCenter.interface, h = new UserRewardRoom(), i = 0, j = 500, k = 300, l = 1e3, m = [], n = [];
    pingItem = {
        timer: 0,
        round: 0,
...
(function() {
    function a(a) {
        UTILITY.mergeOb(b, a), MemoryGame.MODEL.gameConfiguration = b, new View();
        var c = new MemoryCore();
        c.startGame();
    }
    var b = {
        gameNodeId: "game",
